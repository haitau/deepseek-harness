...
| [`company/`](company/README.md) | Company-specific plugins assembled into business-flow profiles (HR specialist prompt, resume parse tool, save-report tool) | Fork-local — not in upstream |
